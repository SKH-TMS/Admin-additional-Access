...
import NavbarAdmin from "../../NavbarAdmin/page"; // Assuming NavbarAdmin is correctly located
...
const TeamCard: React.FC<{ team: TeamDetails }> = ({ team }) => {
  ...
  const handleViewTeamDetails = (e: React.MouseEvent) => {
    ...
    router.push(`/adminData/ParticipantTeamDetails/${encodedTeamId}`);
  };
  ...
  return (
    <div
      className="bg-white border border-gray-200 rounded-lg shadow-md p-5 hover:shadow-xl transition-shadow duration-300 flex flex-col justify-between cursor-pointer group"
...
export default function ParticipantDetailsPage() {
  return (
    <Suspense
      fallback={
        <div>
          <NavbarAdmin /> {/* Include Navbar in fallback */}
